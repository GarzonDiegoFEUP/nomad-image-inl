![docker image](https://github.com/GarzonDiegoFEUP/nomad-image-inl/actions/workflows/docker-publish.yml/badge.svg)

# GarzonDiegoFEUP's NOMAD Oasis Distribution

This is the NOMAD Oasis distribution of GarzonDiegoFEUP.
...
```sh
git clone https://github.com/GarzonDiegoFEUP/nomad-image-inl.git
cd nomad-image-inl
```
...
```sh
curl-L -o nomad-image-inl.zip "https://github.com/GarzonDiegoFEUP/nomad-image-inl/archive/main.zip"
unzip nomad-image-inl.zip
cd nomad-image-inl
```
...
your `docker-compose.yaml` with `ghcr.io/GarzonDiegoFEUP/nomad-image-inl:main` for the services
...
If the plugin is **not** new, you also need to add it under `plugins` in the [nomad.yaml](nomad.yaml)
...
_I get an_ `Error response from daemon: Head "https://ghcr.io/v2/GarzonDiegoFEUP/nomad-image-inl/manifests/main": unauthorized`
